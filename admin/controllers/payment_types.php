 ...
 */
class EhealthportalControllerPayment_types extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Payment_type', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
