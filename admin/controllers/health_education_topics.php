 ...
 */
class EhealthportalControllerHealth_education_topics extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Health_education_topic', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
