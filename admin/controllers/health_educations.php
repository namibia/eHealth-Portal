 ...
 */
class EhealthportalControllerHealth_educations extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Health_education', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
