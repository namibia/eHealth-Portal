 ...
 */
class EhealthportalControllerImmunisations extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Immunisation', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
