 ...
 */
class EhealthportalControllerTests extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Test', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
