 ...
 */
class EhealthportalControllerTesting_reasons extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Testing_reason', $prefix = 'EhealthportalModel', $config = array('ignore_request' => true))
	{
