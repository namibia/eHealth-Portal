 ...
 */
class StrengthTable extends Table implements VersionableTableInterface, TaggableTableInterface, CurrentUserInterface
{
	...
	function __construct(DatabaseDriver $db, ?DispatcherInterface $dispatcher = null)
	{
		...
		$this->typeAlias = 'com_ehealthportal.strength';
		...
		parent::__construct('#__ehealthportal_strength', 'id', $db, $dispatcher);
	}
	...
	public function store($updateNulls = false)
	{
		...
		{
			// New strength. A strength created and created_by field can be set by the user,
