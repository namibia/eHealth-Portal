...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Cervical_cancersModel.php
 ...
 */
class Cervical_cancersModel extends ListModel
{
	...
	{
		// Array of cc_viginal_bleeding language strings
		...
		// Array of cc_v_discharge language strings
		...
		// Array of cc_periods language strings
		if ($name === 'cc_periods')
		{
		...
		// Array of cc_smoking language strings
		if ($name === 'cc_smoking')
		{
		...
		// Array of cc_sex_actve language strings
		...
		// Array of cc_sex_partner language strings
		...
		// Array of pap_smear_collection language strings
		...
		// Array of cc_result language strings
		if ($name === 'cc_result')
		{
