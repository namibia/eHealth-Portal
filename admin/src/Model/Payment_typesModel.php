...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Payment_typesModel.php
...
/**
 * Payment_types List Model
 */
class Payment_typesModel extends ListModel
{
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_payment_type'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_payment_type'))->set($fields)->where($conditions); 
