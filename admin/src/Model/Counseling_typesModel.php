...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Counseling_typesModel.php
...
/**
 * Counseling_types List Model
 */
class Counseling_typesModel extends ListModel
{
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__ehealthportal_counseling_type', 'a'));
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = UtilitiesArrayHelper::check($pks)) !== false || 'bulk' === $pks)
		{
			...
			// From the ehealthportal_counseling_type table
			$query->from($db->quoteName('#__ehealthportal_counseling_type', 'a'));
	...
	*/
	public function getExImPortHeaders()
	{
		...
		$db = Factory::getDbo();
		// get the columns
		$columns = $db->getTableColumns("#__ehealthportal_counseling_type");
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_counseling_type'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_counseling_type'))->set($fields)->where($conditions); 
