...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Nonpay_reasonsModel.php
...
/**
 * Nonpay_reasons List Model
 */
class Nonpay_reasonsModel extends ListModel
{
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_nonpay_reason'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_nonpay_reason'))->set($fields)->where($conditions); 
