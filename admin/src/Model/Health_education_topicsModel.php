...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Health_education_topicsModel.php
...
/**
 * Health_education_topics List Model
 */
class Health_education_topicsModel extends ListModel
{
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_health_education_topic'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_health_education_topic'))->set($fields)->where($conditions); 
