...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Administration_partsModel.php
...
/**
 * Administration_parts List Model
 */
class Administration_partsModel extends ListModel
{
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_administration_part'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_administration_part'))->set($fields)->where($conditions); 
