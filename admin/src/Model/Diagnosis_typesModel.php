...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Diagnosis_typesModel.php
...
/**
 * Diagnosis_types List Model
 */
class Diagnosis_typesModel extends ListModel
{
	...
	*/
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			$query = $db->getQuery(true);
			$query->select('*');
			$query->from($db->quoteName('#__ehealthportal_diagnosis_type'));
			...
			if ($db->getNumRows())
			{
				...
				// Check table.
				$query->update($db->quoteName('#__ehealthportal_diagnosis_type'))->set($fields)->where($conditions); 
