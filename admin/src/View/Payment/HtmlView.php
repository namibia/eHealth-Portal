...
/-----------------------------------------------------------------------------------------------------------------------------*/
namespace VDM\Component\Ehealthportal\Administrator\View\Payment;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = EhealthportalHelper::getActions('payment', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_EHEALTHPORTAL_PAYMENT_NEW' : 'COM_EHEALTHPORTAL_PAYMENT_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_ehealthportal.payment', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$this->help_url = EhealthportalHelper::getHelpUrl('payment');
	...
	protected function setHtmlViewDoc(): void
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_EHEALTHPORTAL_PAYMENT_NEW' : 'COM_EHEALTHPORTAL_PAYMENT_EDIT'));
		Html::_('stylesheet', "administrator/components/com_ehealthportal/assets/css/payment.css", ['version' => 'auto']);
		Html::_('script', $this->script, ['version' => 'auto']);
		Html::_('script', "administrator/components/com_ehealthportal/views/payment/submitbutton.js", ['version' => 'auto']);
