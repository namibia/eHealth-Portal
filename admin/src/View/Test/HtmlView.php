...
/-----------------------------------------------------------------------------------------------------------------------------*/
namespace VDM\Component\Ehealthportal\Administrator\View\Test;
...
class HtmlView extends BaseHtmlView
{
	...
	public function display($tpl = null)
	{
		...
		$this->canDo = EhealthportalHelper::getActions('test', $this->item);
		// get input
	...
	protected function addToolBar()
	{
		...
		ToolbarHelper::title( Text::_($isNew ? 'COM_EHEALTHPORTAL_TEST_NEW' : 'COM_EHEALTHPORTAL_TEST_EDIT'), 'pencil-2 article-add');
		...
		else
		{
			...
			else
			{
				...
				{
					ToolbarHelper::versions('com_ehealthportal.test', $this->item->id);
				}
				if ($this->canDo->get('core.create'))
				{
		...
		$this->help_url = EhealthportalHelper::getHelpUrl('test');
	...
	protected function setHtmlViewDoc(): void
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_EHEALTHPORTAL_TEST_NEW' : 'COM_EHEALTHPORTAL_TEST_EDIT'));
		Html::_('stylesheet', "administrator/components/com_ehealthportal/assets/css/test.css", ['version' => 'auto']);
		Html::_('script', $this->script, ['version' => 'auto']);
		Html::_('script', "administrator/components/com_ehealthportal/views/test/submitbutton.js", ['version' => 'auto']);
