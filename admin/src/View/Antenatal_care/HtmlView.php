...
/-----------------------------------------------------------------------------------------------------------------------------*/
namespace VDM\Component\Ehealthportal\Administrator\View\Antenatal_care;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function setHtmlViewDoc(): void
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_EHEALTHPORTAL_ANTENATAL_CARE_NEW' : 'COM_EHEALTHPORTAL_ANTENATAL_CARE_EDIT'));
