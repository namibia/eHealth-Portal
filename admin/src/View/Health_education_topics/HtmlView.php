...
/-----------------------------------------------------------------------------------------------------------------------------*/
namespace JCB\Component\Ehealthportal\Administrator\View\Health_education_topics;
...
class HtmlView extends BaseHtmlView
{
	...
	{
		$this->getDocument()->setTitle(Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_TOPICS'));
