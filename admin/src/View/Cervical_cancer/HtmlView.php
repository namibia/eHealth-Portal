 ...
 */
namespace VDM\Component\Ehealthportal\Administrator\View\Cervical_cancer;
...
class HtmlView extends BaseHtmlView
{
	...
	protected function setHtmlViewDoc(): void
	{
		...
		$this->getDocument()->setTitle(Text::_($isNew ? 'COM_EHEALTHPORTAL_CERVICAL_CANCER_NEW' : 'COM_EHEALTHPORTAL_CERVICAL_CANCER_EDIT'));
