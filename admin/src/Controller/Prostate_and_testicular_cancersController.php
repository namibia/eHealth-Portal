...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Prostate_and_testicular_cancersController.php
 ...
 */
class Prostate_and_testicular_cancersController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Prostate_and_testicular_cancer', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
