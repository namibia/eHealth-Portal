...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		Health_educationController.php
...
class Health_educationController extends FormController
{
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_ehealthportal.health_education.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_ehealthportal.health_education.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('Health_education', '', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_ehealthportal&view=health_educations' . $this->getRedirectToListAppend(), false));
