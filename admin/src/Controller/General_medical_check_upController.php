...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		General_medical_check_upController.php
...
class General_medical_check_upController extends FormController
{
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		if ($recordId)
		{
			...
			$permission = $user->authorise('core.edit', 'com_ehealthportal.general_medical_check_up.' . (int) $recordId);
			if (!$permission)
			{
				if ($user->authorise('core.edit.own', 'com_ehealthportal.general_medical_check_up.' . $recordId))
				{
	...
	public function batch($model = null)
	{
		...
		// Set the model
		$model = $this->getModel('General_medical_check_up', '', []);

		// Preset the redirect
		$this->setRedirect(Route::_('index.php?option=com_ehealthportal&view=general_medical_check_ups' . $this->getRedirectToListAppend(), false));
