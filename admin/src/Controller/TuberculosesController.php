...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		TuberculosesController.php
 ...
 */
class TuberculosesController extends AdminController
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getModel($name = 'Tuberculosis', $prefix = 'Administrator', $config = ['ignore_request' => true])
	{
