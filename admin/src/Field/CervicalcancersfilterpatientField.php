...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		CervicalcancersfilterpatientField.php
...
/**
 * Cervicalcancersfilterpatient Form Field class for the Ehealthportal component
 */
class CervicalcancersfilterpatientField extends ListField
{
	/**
	 * The cervicalcancersfilterpatient field type.
	 *
	 * @var        string
	 */
	public $type = 'Cervicalcancersfilterpatient';
