...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		FoetalpresentationField.php
 ...
 */
class FoetalpresentationField extends ListField
{
	/**
	...
	protected function getOptions()
	{
		...
		if ($items)
		{
			...
			{
				$options[] = Html::_('select.option', $item->id, $item->foetal_presentation_name);
			}
		}
		return $options;
	}
