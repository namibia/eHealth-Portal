...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		GeneralmedicalcheckupsfilterpatientField.php
...
/**
 * Generalmedicalcheckupsfilterpatient Form Field class for the Ehealthportal component
 */
class GeneralmedicalcheckupsfilterpatientField extends ListField
{
	/**
