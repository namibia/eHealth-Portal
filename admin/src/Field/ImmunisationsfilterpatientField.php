...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		ImmunisationsfilterpatientField.php
...
/**
 * Immunisationsfilterpatient Form Field class for the Ehealthportal component
 */
class ImmunisationsfilterpatientField extends ListField
{
	/**
