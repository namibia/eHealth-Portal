...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		HealtheducationsfilterpatientField.php
...
/**
 * Healtheducationsfilterpatient Form Field class for the Ehealthportal component
 */
class HealtheducationsfilterpatientField extends ListField
{
	/**
	 * The healtheducationsfilterpatient field type.
	 *
	 * @var        string
	 */
	public $type = 'Healtheducationsfilterpatient';
