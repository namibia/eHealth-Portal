...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		VmmcsfilterpatientField.php
...
/**
 * Vmmcsfilterpatient Form Field class for the Ehealthportal component
 */
class VmmcsfilterpatientField extends ListField
{
	/**
