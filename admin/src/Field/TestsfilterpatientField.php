...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		TestsfilterpatientField.php
...
/**
 * Testsfilterpatient Form Field class for the Ehealthportal component
 */
class TestsfilterpatientField extends ListField
{
	/**
	 * The testsfilterpatient field type.
	 *
	 * @var        string
	 */
	public $type = 'Testsfilterpatient';
