...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		AdministrationpartsField.php
 ...
 */
class AdministrationpartsField extends ListField
{
	/**
	...
	protected function getOptions()
	{
		...
		if ($items)
		{
			...
			{
				$options[] = Html::_('select.option', $item->id, $item->administration_part_name);
			}
		}
		return $options;
	}
