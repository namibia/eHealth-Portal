 ...
 */
class ReferralsField extends ListField
{
	/**
	...
	protected function getOptions()
	{
		...
		if ($items)
		{
			...
			{
				$options[] = Html::_('select.option', '', Text::_('COM_EHEALTHPORTAL_SELECT_OPTION'));
			}
			foreach($items as $item)
			{
				$options[] = Html::_('select.option', $item->id, $item->referral_name);
			}
		}
		return $options;
	}
