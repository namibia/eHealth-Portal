...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		PaymentsfilterpatientField.php
...
/**
 * Paymentsfilterpatient Form Field class for the Ehealthportal component
 */
class PaymentsfilterpatientField extends ListField
{
	/**
	 * The paymentsfilterpatient field type.
	 *
	 * @var        string
	 */
	public $type = 'Paymentsfilterpatient';
