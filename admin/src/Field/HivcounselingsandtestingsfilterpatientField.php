...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		HivcounselingsandtestingsfilterpatientField.php
...
/**
 * Hivcounselingsandtestingsfilterpatient Form Field class for the Ehealthportal component
 */
class HivcounselingsandtestingsfilterpatientField extends ListField
{
	/**
	 * The hivcounselingsandtestingsfilterpatient field type.
	 *
	 * @var        string
	 */
	public $type = 'Hivcounselingsandtestingsfilterpatient';
	...
	protected function getOptions()
	{
		...
		if ($_results)
		{
			...
			foreach ($_results as $patient)
			{
				...
				$_filter[] = Html::_('select.option', $patient,
					Factory::getContainer()->
					get(\Joomla\CMS\User\UserFactoryInterface::class)->
					loadUserById($patient)->name
					);
			}
		}
		return $_filter;
