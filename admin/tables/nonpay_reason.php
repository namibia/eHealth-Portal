 ...
 */
class EhealthportalTableNonpay_reason extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_nonpay_reason', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.nonpay_reason'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('nonpay_reason', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.nonpay_reason.'.(int) $this->$k;
	}
