 ...
 */
class EhealthportalTableHiv_counseling_and_testing extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_hiv_counseling_and_testing', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.hiv_counseling_and_testing'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('hiv_counseling_and_testing', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.hiv_counseling_and_testing.'.(int) $this->$k;
	}
