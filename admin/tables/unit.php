 ...
 * Units Table class
 */
class Ehealth_portalTableUnit extends JTable
{
	/**
	...
	{
		parent::__construct('#__ehealth_portal_unit', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealth_portal.unit'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_EHEALTH_PORTAL_UNIT_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_ehealth_portal.unit.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealth_portal.unit.'.(int) $this->$k;
	}
