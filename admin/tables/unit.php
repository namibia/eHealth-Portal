 ...
 * Units Table class
 */
class EhealthportalTableUnit extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_unit', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.unit'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('unit', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.unit.'.(int) $this->$k;
	}
