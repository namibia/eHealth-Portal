 ...
 */
class EhealthportalTableFoetal_presentation extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_foetal_presentation', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.foetal_presentation'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('foetal_presentation', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.foetal_presentation.'.(int) $this->$k;
	}
