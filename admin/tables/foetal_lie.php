 ...
 */
class EhealthportalTableFoetal_lie extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_foetal_lie', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.foetal_lie'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('foetal_lie', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.foetal_lie.'.(int) $this->$k;
	}
