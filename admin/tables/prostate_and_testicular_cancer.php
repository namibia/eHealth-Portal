 ...
 */
class EhealthportalTableProstate_and_testicular_cancer extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_prostate_and_testicular_cancer', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.prostate_and_testicular_cancer'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('prostate_and_testicular_cancer', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.prostate_and_testicular_cancer.'.(int) $this->$k;
	}
