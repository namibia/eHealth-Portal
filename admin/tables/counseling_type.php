 ...
 */
class Ehealth_portalTableCounseling_type extends JTable
{
	/**
	...
	{
		parent::__construct('#__ehealth_portal_counseling_type', 'id', $db);

		// Adding History Options
		JTableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealth_portal.counseling_type'));
	}	
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			{
				$this->setError(JText::_('COM_EHEALTH_PORTAL_COUNSELING_TYPE_ERROR_UNIQUE_ALIAS'));
				return false;
			}
		}
	...
	public function check()
	{
		...
		if (!$this->getRules())
		{
			$rules = $this->getDefaultAssetValues('com_ehealth_portal.counseling_type.'.$this->id);
			$this->setRules($rules);
		}
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealth_portal.counseling_type.'.(int) $this->$k;
	}
