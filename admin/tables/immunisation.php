 ...
 */
class EhealthportalTableImmunisation extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_immunisation', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.immunisation'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('immunisation', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.immunisation.'.(int) $this->$k;
	}
