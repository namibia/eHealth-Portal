 ...
 */
class EhealthportalTableTuberculosis extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_tuberculosis', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.tuberculosis'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('tuberculosis', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.tuberculosis.'.(int) $this->$k;
	}
