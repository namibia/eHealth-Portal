 ...
 */
class EhealthportalTableMedication extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_medication', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.medication'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('medication', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.medication.'.(int) $this->$k;
	}
