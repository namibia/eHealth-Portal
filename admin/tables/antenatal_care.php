 ...
 */
class EhealthportalTableAntenatal_care extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_antenatal_care', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.antenatal_care'));
	}
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.antenatal_care.'.(int) $this->$k;
	}
