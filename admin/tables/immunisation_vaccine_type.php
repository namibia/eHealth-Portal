 ...
 */
class EhealthportalTableImmunisation_vaccine_type extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_immunisation_vaccine_type', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.immunisation_vaccine_type'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('immunisation_vaccine_type', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.immunisation_vaccine_type.'.(int) $this->$k;
	}
