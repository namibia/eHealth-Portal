 ...
 */
class EhealthportalTableBreast_cancer extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_breast_cancer', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.breast_cancer'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('breast_cancer', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.breast_cancer.'.(int) $this->$k;
	}
