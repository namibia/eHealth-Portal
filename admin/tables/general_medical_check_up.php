 ...
 */
class EhealthportalTableGeneral_medical_check_up extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_general_medical_check_up', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.general_medical_check_up'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('general_medical_check_up', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.general_medical_check_up.'.(int) $this->$k;
	}
