 ...
 */
class EhealthportalTableHealth_education extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_health_education', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.health_education'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('health_education', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.health_education.'.(int) $this->$k;
	}
