 ...
 */
class EhealthportalTableAdministration_part extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_administration_part', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.administration_part'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('administration_part', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.administration_part.'.(int) $this->$k;
	}
