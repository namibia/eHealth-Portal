 ...
 */
class EhealthportalTablePlanning_type extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_planning_type', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.planning_type'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('planning_type', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.planning_type.'.(int) $this->$k;
	}
