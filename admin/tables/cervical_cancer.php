 ...
 */
class EhealthportalTableCervical_cancer extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_cervical_cancer', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.cervical_cancer'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('cervical_cancer', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.cervical_cancer.'.(int) $this->$k;
	}
