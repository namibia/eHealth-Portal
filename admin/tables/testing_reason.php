 ...
 */
class EhealthportalTableTesting_reason extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_testing_reason', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.testing_reason'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('testing_reason', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.testing_reason.'.(int) $this->$k;
	}
