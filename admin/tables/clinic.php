 ...
 * Clinics Table class
 */
class EhealthportalTableClinic extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_clinic', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.clinic'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('clinic', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.clinic.'.(int) $this->$k;
	}
