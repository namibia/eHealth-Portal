 ...
 */
class EhealthportalTableImmunisation_type extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_immunisation_type', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.immunisation_type'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('immunisation_type', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.immunisation_type.'.(int) $this->$k;
	}
