 ...
 */
class EhealthportalTableHealth_education_topic extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_health_education_topic', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.health_education_topic'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('health_education_topic', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.health_education_topic.'.(int) $this->$k;
	}
