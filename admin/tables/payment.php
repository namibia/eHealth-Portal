 ...
 */
class EhealthportalTablePayment extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_payment', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.payment'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('payment', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.payment.'.(int) $this->$k;
	}
