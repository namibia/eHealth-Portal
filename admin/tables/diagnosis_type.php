 ...
 */
class EhealthportalTableDiagnosis_type extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_diagnosis_type', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.diagnosis_type'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('diagnosis_type', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.diagnosis_type.'.(int) $this->$k;
	}
