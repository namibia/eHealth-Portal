 ...
 * Vmmcs Table class
 */
class EhealthportalTableVmmc extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_vmmc', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.vmmc'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('vmmc', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.vmmc.'.(int) $this->$k;
	}
