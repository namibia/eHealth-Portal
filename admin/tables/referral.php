 ...
 */
class EhealthportalTableReferral extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_referral', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.referral'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('referral', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.referral.'.(int) $this->$k;
	}
