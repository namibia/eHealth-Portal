 ...
 */
class EhealthportalTablePayment_type extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_payment_type', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.payment_type'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('payment_type', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.payment_type.'.(int) $this->$k;
	}
