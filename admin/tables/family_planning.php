 ...
 */
class EhealthportalTableFamily_planning extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_family_planning', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.family_planning'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('family_planning', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.family_planning.'.(int) $this->$k;
	}
