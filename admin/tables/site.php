 ...
 * Sites Table class
 */
class EhealthportalTableSite extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_site', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.site'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('site', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.site.'.(int) $this->$k;
	}
