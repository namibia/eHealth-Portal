 ...
 */
class EhealthportalTableFoetal_engagement extends Table
{
	/**
	...
	{
		parent::__construct('#__ehealthportal_foetal_engagement', 'id', $db);

		// Adding History Options
		TableObserverContenthistory::createObserver($this, array('typeAlias' => 'com_ehealthportal.foetal_engagement'));
	}
	...
	public function store($updateNulls = false)
	{
		...
		if (isset($this->alias))
		{
			...
			$table = Table::getInstance('foetal_engagement', 'EhealthportalTable');
	...
	{
		$k = $this->_tbl_key;
		return 'com_ehealthportal.foetal_engagement.'.(int) $this->$k;
	}
