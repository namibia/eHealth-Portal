 ...
 */
class Ehealth_portalModelFoetal_presentations extends JModelList
{
	...
	protected function checkInNow()
	{
		...
		if ($time)
		{
			...
			if ($db->getNumRows())
			{
				...
				// Check table
				$query->update($db->quoteName('#__ehealth_portal_foetal_presentation'))->set($fields)->where($conditions); 
