...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		health_education_topic.php
 ...
 */
class EhealthportalModelHealth_education_topic extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'health_education_topic', $prefix = 'EhealthportalTable', $config = [])
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('core.delete', 'com_ehealthportal.health_education_topic.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		return Factory::getUser()->authorise('core.edit', 'com_ehealthportal.health_education_topic.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
