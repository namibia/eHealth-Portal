 ...
 */
class EhealthportalModelTesting_reason extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'testing_reason', $prefix = 'EhealthportalTable', $config = [])
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('core.delete', 'com_ehealthportal.testing_reason.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		return Factory::getUser()->authorise('core.edit', 'com_ehealthportal.testing_reason.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
