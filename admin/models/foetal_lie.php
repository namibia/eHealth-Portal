 ...
 */
class EhealthportalModelFoetal_lie extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'foetal_lie', $prefix = 'EhealthportalTable', $config = [])
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('core.delete', 'com_ehealthportal.foetal_lie.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		return Factory::getUser()->authorise('core.edit', 'com_ehealthportal.foetal_lie.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
