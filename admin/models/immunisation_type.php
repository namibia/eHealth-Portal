...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		immunisation_type.php
 ...
 */
class EhealthportalModelImmunisation_type extends AdminModel
{
	/**
	 ...
	 * @since   1.6
	 */
	public function getTable($type = 'immunisation_type', $prefix = 'EhealthportalTable', $config = [])
	{
	...
	protected function canDelete($record)
	{
		if (!empty($record->id))
		{
			...
			return $user->authorise('core.delete', 'com_ehealthportal.immunisation_type.' . (int) $record->id);
		}
		return false;
	}
	...
	protected function allowEdit($data = [], $key = 'id')
	{
		...
		return Factory::getUser()->authorise('core.edit', 'com_ehealthportal.immunisation_type.'. ((int) isset($data[$key]) ? $data[$key] : 0)) or parent::allowEdit($data, $key);
	}
