...
class Ehealth_portalModelAntenatal_cares extends JModelList
{
	...
	protected function getListQuery()
	{
		...
		// From the ehealth_portal_foetal_lie table.
		...
		// From the ehealth_portal_foetal_presentation table.
		...
		// From the ehealth_portal_foetal_engagement table.
		...
		elseif (Ehealth_portalHelper::checkString($_foetal_lie))
		{
	...
	public function getExportData($pks, $user = null)
	{
		...
		if (($pks_size = Ehealth_portalHelper::checkArray($pks)) !== false || 'bulk' === $pks)
		{
			...
			// From the ehealth_portal_antenatal_care table
			$query->from($db->quoteName('#__ehealth_portal_antenatal_care', 'a'));
