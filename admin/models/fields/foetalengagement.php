...
/-------------------------------------------------------------------------------------------------------------------------------/
	...
	@subpackage		foetalengagement.php
 ...
 */
class JFormFieldFoetalengagement extends JFormFieldList
{
	/**
	...
	protected function getOptions()
	{
		...
		if ($items)
		{
			...
			{
				$options[] = JHtml::_('select.option', $item->id, $item->foetal_engagement_name);
			}
		}
		return $options;
	}
