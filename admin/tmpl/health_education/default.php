...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'health_educationTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'health_educationTab', 'details', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'health_educationTab', 'publishing', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'health_educationTab', 'permissions', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
