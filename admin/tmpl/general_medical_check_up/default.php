...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'general_medical_check_upTab', array('active' => 'vital_signs')); ?>

	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'vital_signs', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_VITAL_SIGNS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'diagnosis', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_DIAGNOSIS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'referrals', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_REFERRALS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'dispensing', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_DISPENSING', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'publishing', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'general_medical_check_upTab', 'permissions', Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
