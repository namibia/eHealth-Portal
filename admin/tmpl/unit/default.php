...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'unitTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'unitTab', 'details', Text::_('COM_EHEALTHPORTAL_UNIT_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'unitTab', 'publishing', Text::_('COM_EHEALTHPORTAL_UNIT_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'unitTab', 'permissions', Text::_('COM_EHEALTHPORTAL_UNIT_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
