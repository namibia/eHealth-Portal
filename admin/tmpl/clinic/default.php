...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'clinicTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'clinicTab', 'details', Text::_('COM_EHEALTHPORTAL_CLINIC_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'clinicTab', 'publishing', Text::_('COM_EHEALTHPORTAL_CLINIC_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'clinicTab', 'permissions', Text::_('COM_EHEALTHPORTAL_CLINIC_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
