...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'tuberculosisTab', array('active' => 'screening')); ?>

	<?php echo Html::_('uitab.addTab', 'tuberculosisTab', 'screening', Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_SCREENING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'tuberculosisTab', 'sputum_collection', Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_SPUTUM_COLLECTION', true)); ?>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'tuberculosisTab', 'referrals', Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_REFERRALS', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'tuberculosisTab', 'publishing', Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'tuberculosisTab', 'permissions', Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
