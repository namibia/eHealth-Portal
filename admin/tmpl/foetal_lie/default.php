...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'foetal_lieTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'foetal_lieTab', 'details', Text::_('COM_EHEALTHPORTAL_FOETAL_LIE_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'foetal_lieTab', 'publishing', Text::_('COM_EHEALTHPORTAL_FOETAL_LIE_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'foetal_lieTab', 'permissions', Text::_('COM_EHEALTHPORTAL_FOETAL_LIE_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
