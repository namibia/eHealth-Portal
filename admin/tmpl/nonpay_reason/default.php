...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'nonpay_reasonTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'nonpay_reasonTab', 'details', Text::_('COM_EHEALTHPORTAL_NONPAY_REASON_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'nonpay_reasonTab', 'publishing', Text::_('COM_EHEALTHPORTAL_NONPAY_REASON_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'nonpay_reasonTab', 'permissions', Text::_('COM_EHEALTHPORTAL_NONPAY_REASON_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
