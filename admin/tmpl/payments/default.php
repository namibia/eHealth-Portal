...
if ($this->saveOrder)
{
	$saveOrderingUrl = 'index.php?option=com_ehealthportal&task=payments.saveOrderAjax&tmpl=component';
	Html::_('sortablelist.sortable', 'paymentList', 'adminForm', strtolower($this->listDirn), $saveOrderingUrl);
}
?>
<form action="<?php echo Route::_('index.php?option=com_ehealthportal&view=payments'); ?>" method="post" name="adminForm" id="adminForm">
...
<?php else : ?>
	...
	<?php if ($this->canCreate && $this->canEdit) : ?>
		<?php echo Html::_(
			...
			'collapseModal',
			array(
				'title' => Text::_('COM_EHEALTHPORTAL_PAYMENTS_BATCH_OPTIONS'),
