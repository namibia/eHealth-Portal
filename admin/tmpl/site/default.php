...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'siteTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'siteTab', 'details', Text::_('COM_EHEALTHPORTAL_SITE_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'siteTab', 'publishing', Text::_('COM_EHEALTHPORTAL_SITE_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'siteTab', 'permissions', Text::_('COM_EHEALTHPORTAL_SITE_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
