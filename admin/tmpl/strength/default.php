...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'strengthTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'strengthTab', 'details', Text::_('COM_EHEALTHPORTAL_STRENGTH_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'strengthTab', 'publishing', Text::_('COM_EHEALTHPORTAL_STRENGTH_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'strengthTab', 'permissions', Text::_('COM_EHEALTHPORTAL_STRENGTH_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
