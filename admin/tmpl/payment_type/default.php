...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'payment_typeTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'payment_typeTab', 'details', Text::_('COM_EHEALTHPORTAL_PAYMENT_TYPE_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'payment_typeTab', 'publishing', Text::_('COM_EHEALTHPORTAL_PAYMENT_TYPE_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'payment_typeTab', 'permissions', Text::_('COM_EHEALTHPORTAL_PAYMENT_TYPE_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
