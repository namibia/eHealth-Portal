...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'family_planningTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'family_planningTab', 'details', Text::_('COM_EHEALTHPORTAL_FAMILY_PLANNING_DETAILS', true)); ?>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'family_planningTab', 'publishing', Text::_('COM_EHEALTHPORTAL_FAMILY_PLANNING_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'family_planningTab', 'permissions', Text::_('COM_EHEALTHPORTAL_FAMILY_PLANNING_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
