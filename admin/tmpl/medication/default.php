...
<div class="main-card">
	...
	<?php echo Html::_('uitab.startTabSet', 'medicationTab', array('active' => 'details')); ?>

	<?php echo Html::_('uitab.addTab', 'medicationTab', 'details', Text::_('COM_EHEALTHPORTAL_MEDICATION_DETAILS', true)); ?>
		<div class="row">
		</div>
		<div class="row">
			<div class="col-md-12">
	...
	<?php echo Html::_('uitab.addTab', 'medicationTab', 'publishing', Text::_('COM_EHEALTHPORTAL_MEDICATION_PUBLISHING', true)); ?>
		<div class="row">
			<div class="col-md-6">
	...
	<?php echo Html::_('uitab.addTab', 'medicationTab', 'permissions', Text::_('COM_EHEALTHPORTAL_MEDICATION_PERMISSION', true)); ?>
		<div class="row">
			<div class="col-md-12">
