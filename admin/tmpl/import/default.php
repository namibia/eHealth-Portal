...
<form enctype="multipart/form-data" action="<?php echo Route::_('index.php?option=com_ehealthportal&view=import');?>" method="post" name="adminForm" id="adminForm" class="form-horizontal form-validate">
	...
	<?php else: ?>
		...
		<?php echo Html::_('uitab.addTab', 'myTab', 'upload', Text::_('COM_EHEALTHPORTAL_IMPORT_FROM_UPLOAD', true)); ?>
			<fieldset class="uploadform">
		...
		<?php echo Html::_('uitab.addTab', 'myTab', 'directory', Text::_('COM_EHEALTHPORTAL_IMPORT_FROM_DIRECTORY', true)); ?>
			<fieldset class="uploadform">
				<legend><?php echo Text::_('COM_EHEALTHPORTAL_IMPORT_UPDATE_DATA'); ?></legend>
				<div class="control-group">
		...
		<?php echo Html::_('uitab.addTab', 'myTab', 'url', Text::_('COM_EHEALTHPORTAL_IMPORT_FROM_URL', true)); ?>
			<fieldset class="uploadform">
				<legend><?php echo Text::_('COM_EHEALTHPORTAL_IMPORT_UPDATE_DATA'); ?></legend>
				<div class="control-group">
