...
<form action="<?php echo JRoute::_('index.php?option=com_ehealth_portal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('unit.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo JHtml::_('bootstrap.startTabSet', 'unitTab', array('active' => 'details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'unitTab', 'details', JText::_('COM_EHEALTH_PORTAL_UNIT_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('unit.details_fullwidth', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>

	<?php $this->ignore_fieldsets = array('details','metadata','vdmmetadata','accesscontrol'); ?>
	<?php $this->tab_name = 'unitTab'; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'unitTab', 'publishing', JText::_('COM_EHEALTH_PORTAL_UNIT_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('unit.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('unit.publlshing', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'unitTab', 'permissions', JText::_('COM_EHEALTH_PORTAL_UNIT_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
