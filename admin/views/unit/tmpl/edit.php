...
<form action="<?php echo Route::_('index.php?option=com_ehealthportal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo LayoutHelper::render('unit.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo Html::_('bootstrap.startTabSet', 'unitTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'unitTab', 'details', Text::_('COM_EHEALTHPORTAL_UNIT_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('unit.details_fullwidth', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'unitTab', 'publishing', Text::_('COM_EHEALTHPORTAL_UNIT_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('unit.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('unit.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'unitTab', 'permissions', Text::_('COM_EHEALTHPORTAL_UNIT_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
