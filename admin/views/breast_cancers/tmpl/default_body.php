...
$edit = "index.php?option=com_ehealth_portal&view=breast_cancers&task=breast_cancer.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Ehealth_portalHelper::getActions('breast_cancer',$item,'breast_cancers');
	?>
