...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'testing_reasonTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'testing_reasonTab', 'details', Text::_('COM_EHEALTHPORTAL_TESTING_REASON_DETAILS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'testing_reasonTab', 'publishing', Text::_('COM_EHEALTHPORTAL_TESTING_REASON_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'testing_reasonTab', 'permissions', Text::_('COM_EHEALTHPORTAL_TESTING_REASON_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
