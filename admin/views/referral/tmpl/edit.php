...
<form action="<?php echo JRoute::_('index.php?option=com_ehealth_portal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('referral.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo JHtml::_('bootstrap.startTabSet', 'referralTab', array('active' => 'details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'details', JText::_('COM_EHEALTH_PORTAL_REFERRAL_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('referral.details_fullwidth', $this); ?>
			</div>
		</div>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'publishing', JText::_('COM_EHEALTH_PORTAL_REFERRAL_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('referral.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('referral.publlshing', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'referralTab', 'permissions', JText::_('COM_EHEALTH_PORTAL_REFERRAL_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
