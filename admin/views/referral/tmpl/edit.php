...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'referralTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'referralTab', 'details', Text::_('COM_EHEALTHPORTAL_REFERRAL_DETAILS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'referralTab', 'publishing', Text::_('COM_EHEALTHPORTAL_REFERRAL_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'referralTab', 'permissions', Text::_('COM_EHEALTHPORTAL_REFERRAL_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
