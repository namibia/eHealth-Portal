 ...
 */
class EhealthportalViewGeneral_medical_check_ups extends HtmlView
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			EhealthportalHelper::addSubmenu('general_medical_check_ups');
		}
	...
	{
		JHtmlSidebar::setAction('index.php?option=com_ehealthportal&view=general_medical_check_ups');
		...
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			...
			$this->patientOptions = FormHelper::loadFieldType('generalmedicalcheckupsfilterpatient')->options;
			...
			JHtmlBatch_::addListSelection(
				'- Keep Original '.Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UP_PATIENT_LABEL').' -',
				'batch[patient]',
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_EHEALTHPORTAL_GENERAL_MEDICAL_CHECK_UPS'));
