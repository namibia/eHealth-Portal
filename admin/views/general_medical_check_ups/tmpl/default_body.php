...
$edit = "index.php?option=com_ehealth_portal&view=general_medical_check_ups&task=general_medical_check_up.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Ehealth_portalHelper::getActions('general_medical_check_up',$item,'general_medical_check_ups');
	?>
