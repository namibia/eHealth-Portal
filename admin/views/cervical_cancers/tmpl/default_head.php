...
<tr>
	...
	<?php endif; ?>
	<th class="nowrap" >
			<?php echo JHtml::_('searchtools.sort', 'COM_EHEALTH_PORTAL_CERVICAL_CANCER_PATIENT_LABEL', 'a.patient', $this->listDirn, $this->listOrder); ?>
	</th>
	...
	<th class="nowrap hidden-phone" >
			<?php echo JText::_('COM_EHEALTH_PORTAL_CERVICAL_CANCER_REFERRAL_LABEL'); ?>
	</th>
	<th class="nowrap hidden-phone" >
			<?php echo JText::_('COM_EHEALTH_PORTAL_CERVICAL_CANCER_REASON_LABEL'); ?>
	</th>
	<?php if ($this->canState): ?>
		<th width="10" class="nowrap center" >
			<?php echo JHtml::_('searchtools.sort', 'COM_EHEALTH_PORTAL_CERVICAL_CANCER_STATUS', 'a.published', $this->listDirn, $this->listOrder); ?>
		</th>
	<?php else: ?>
		<th width="10" class="nowrap center" >
	...
	<th width="5" class="nowrap center hidden-phone" >
			<?php echo JHtml::_('searchtools.sort', 'COM_EHEALTH_PORTAL_CERVICAL_CANCER_ID', 'a.id', $this->listDirn, $this->listOrder); ?>
	</th>
</tr>