...
<form action="<?php echo Route::_('index.php?option=com_ehealthportal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo LayoutHelper::render('health_education.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo Html::_('bootstrap.startTabSet', 'health_educationTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'health_educationTab', 'details', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('health_education.details_left', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'health_educationTab', 'publishing', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('health_education.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('health_education.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'health_educationTab', 'permissions', Text::_('COM_EHEALTHPORTAL_HEALTH_EDUCATION_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
