...
<form action="<?php echo Route::_('index.php?option=com_ehealthportal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo LayoutHelper::render('strength.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo Html::_('bootstrap.startTabSet', 'strengthTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'strengthTab', 'details', Text::_('COM_EHEALTHPORTAL_STRENGTH_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('strength.details_fullwidth', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'strengthTab', 'publishing', Text::_('COM_EHEALTHPORTAL_STRENGTH_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('strength.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('strength.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'strengthTab', 'permissions', Text::_('COM_EHEALTHPORTAL_STRENGTH_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
