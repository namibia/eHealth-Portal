...
$edit = "index.php?option=com_ehealth_portal&view=immunisations&task=immunisation.edit";
...
<?php foreach ($this->items as $i => $item): ?>
	<?php
		...
		$canDo = Ehealth_portalHelper::getActions('immunisation',$item,'immunisations');
	?>
