...
<form action="<?php echo Route::_('index.php?option=com_ehealthportal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo LayoutHelper::render('site.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo Html::_('bootstrap.startTabSet', 'siteTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'siteTab', 'details', Text::_('COM_EHEALTHPORTAL_SITE_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('site.details_left', $this); ?>
			</div>
		</div>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo LayoutHelper::render('site.details_fullwidth', $this); ?>
			</div>
		</div>
	...
	<?php echo Html::_('bootstrap.addTab', 'siteTab', 'publishing', Text::_('COM_EHEALTHPORTAL_SITE_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo LayoutHelper::render('site.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo LayoutHelper::render('site.publlshing', $this); ?>
			</div>
		</div>
	<?php echo Html::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'siteTab', 'permissions', Text::_('COM_EHEALTHPORTAL_SITE_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
