...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'family_planningTab', 'details', JText::_('COM_EHEALTH_PORTAL_FAMILY_PLANNING_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'family_planningTab', 'publishing', JText::_('COM_EHEALTH_PORTAL_FAMILY_PLANNING_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'family_planningTab', 'permissions', JText::_('COM_EHEALTH_PORTAL_FAMILY_PLANNING_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
