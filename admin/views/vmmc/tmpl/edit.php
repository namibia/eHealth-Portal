...
<form action="<?php echo JRoute::_('index.php?option=com_ehealth_portal&layout=edit&id='. (int) $this->item->id . $this->referral); ?>" method="post" name="adminForm" id="adminForm" class="form-validate" enctype="multipart/form-data">
	...
	<?php echo JLayoutHelper::render('vmmc.details_above', $this); ?>
<div class="form-horizontal">

	<?php echo JHtml::_('bootstrap.startTabSet', 'vmmcTab', array('active' => 'details')); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'details', JText::_('COM_EHEALTH_PORTAL_VMMC_DETAILS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
				<?php echo JLayoutHelper::render('vmmc.details_left', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>

	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'referrals', JText::_('COM_EHEALTH_PORTAL_VMMC_REFERRALS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('vmmc.referrals_left', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('vmmc.referrals_right', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'publishing', JText::_('COM_EHEALTH_PORTAL_VMMC_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
				<?php echo JLayoutHelper::render('vmmc.publishing', $this); ?>
			</div>
			<div class="span6">
				<?php echo JLayoutHelper::render('vmmc.publlshing', $this); ?>
			</div>
		</div>
	<?php echo JHtml::_('bootstrap.endTab'); ?>
	<?php endif; ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'vmmcTab', 'permissions', JText::_('COM_EHEALTH_PORTAL_VMMC_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
