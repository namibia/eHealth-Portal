...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'vmmcTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'vmmcTab', 'details', Text::_('COM_EHEALTHPORTAL_VMMC_DETAILS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'vmmcTab', 'referrals', Text::_('COM_EHEALTHPORTAL_VMMC_REFERRALS', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'vmmcTab', 'publishing', Text::_('COM_EHEALTHPORTAL_VMMC_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'vmmcTab', 'permissions', Text::_('COM_EHEALTHPORTAL_VMMC_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
