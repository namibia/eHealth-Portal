...
<div class="form-horizontal">
	...
	<?php echo Html::_('bootstrap.startTabSet', 'paymentTab', array('active' => 'details')); ?>

	<?php echo Html::_('bootstrap.addTab', 'paymentTab', 'details', Text::_('COM_EHEALTHPORTAL_PAYMENT_DETAILS', true)); ?>
	...
	<?php echo Html::_('bootstrap.addTab', 'paymentTab', 'publishing', Text::_('COM_EHEALTHPORTAL_PAYMENT_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo Html::_('bootstrap.addTab', 'paymentTab', 'permissions', Text::_('COM_EHEALTHPORTAL_PAYMENT_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
