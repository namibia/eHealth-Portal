...
<div class="form-horizontal">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'paymentTab', 'details', JText::_('COM_EHEALTH_PORTAL_PAYMENT_DETAILS', true)); ?>
	...
	<?php echo JHtml::_('bootstrap.addTab', 'paymentTab', 'publishing', JText::_('COM_EHEALTH_PORTAL_PAYMENT_PUBLISHING', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span6">
	...
	<?php echo JHtml::_('bootstrap.addTab', 'paymentTab', 'permissions', JText::_('COM_EHEALTH_PORTAL_PAYMENT_PERMISSION', true)); ?>
		<div class="row-fluid form-horizontal-desktop">
			<div class="span12">
