	...
	protected function addToolBar()
	{
		...
		if (Ehealth_portalHelper::checkString($this->referral))
		{
			if ($this->canDo->get('core.create') && $isNew)
			{
				...
				JToolBarHelper::save('diagnosis_type.save', 'JTOOLBAR_SAVE');
			}
			...
			if ($isNew)
			{
				...
				JToolBarHelper::cancel('diagnosis_type.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				// We can close it.
				JToolBarHelper::cancel('diagnosis_type.cancel', 'JTOOLBAR_CLOSE');
			}
		}
		else
		{
			if ($isNew)
			{
				...
				{
					JToolBarHelper::apply('diagnosis_type.apply', 'JTOOLBAR_APPLY');
					JToolBarHelper::save('diagnosis_type.save', 'JTOOLBAR_SAVE');
					JToolBarHelper::custom('diagnosis_type.save2new', 'save-new.png', 'save-new_f2.png', 'JTOOLBAR_SAVE_AND_NEW', false);
				};
				JToolBarHelper::cancel('diagnosis_type.cancel', 'JTOOLBAR_CANCEL');
			}
			else
			{
				...
				if ($this->canDo->get('core.create'))
				{
					JToolBarHelper::custom('diagnosis_type.save2copy', 'save-copy.png', 'save-copy_f2.png', 'JTOOLBAR_SAVE_AS_COPY', false);
				}
				JToolBarHelper::cancel('diagnosis_type.cancel', 'JTOOLBAR_CLOSE');
			}
		}
