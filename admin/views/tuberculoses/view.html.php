 ...
 */
class EhealthportalViewTuberculoses extends HtmlView
{
	/**
	...
	function display($tpl = null)
	{
		if ($this->getLayout() !== 'modal')
		{
			...
			EhealthportalHelper::addSubmenu('tuberculoses');
		}
	...
	{
		JHtmlSidebar::setAction('index.php?option=com_ehealthportal&view=tuberculoses');
		...
		if ($this->canBatch && $this->canCreate && $this->canEdit)
		{
			...
			$this->patientOptions = FormHelper::loadFieldType('tuberculosesfilterpatient')->options;
			...
			JHtmlBatch_::addListSelection(
				'- Keep Original '.Text::_('COM_EHEALTHPORTAL_TUBERCULOSIS_PATIENT_LABEL').' -',
				'batch[patient]',
	...
	protected function setDocument()
	{
		...
		$this->document->setTitle(Text::_('COM_EHEALTHPORTAL_TUBERCULOSES'));
